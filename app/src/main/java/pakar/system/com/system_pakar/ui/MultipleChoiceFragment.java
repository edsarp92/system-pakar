...
import pakar.system.com.system_pakar.viewmodel.MultipleFixedChoicePage;
...
public class MultipleChoiceFragment extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        mPage.getData().putStringArrayList(PageModel.SIMPLE_DATA_KEY, selections);
