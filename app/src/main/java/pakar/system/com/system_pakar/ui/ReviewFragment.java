...
public class ReviewFragment extends ListFragment implements Callbacks {
    private Callbacks mCallbacks;
    private AbstractWizardModel mWizardModel;
    private List<ReviewItemModel> mCurrentReviewItems;
    ...
    @Override
    public void onPageDataChanged(PageModel changedPage) {
        ArrayList<ReviewItemModel> reviewItems = new ArrayList<ReviewItemModel>();
        for (PageModel page : mWizardModel.getCurrentPageSequence()) {
            page.getReviewItems(reviewItems);
        }
        Collections.sort(reviewItems, new Comparator<ReviewItemModel>() {
            @Override
            public int compare(ReviewItemModel a, ReviewItemModel b) {
    ...
    private class ReviewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup container) {
            ...
            ReviewItemModel reviewItem = mCurrentReviewItems.get(position);
